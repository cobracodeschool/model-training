...
import openai
openai.api_key = "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"


# Replace FINE_TUNED_MODEL with the name of your fine-tuned model
model_name = "curie:ft-personal-2023-03-15-02-50-26"
...
def on_submit():
   ...
   completion = openai.Completion.create(model=model_name, prompt=prompt, max_tokens=150, stop=["END"])
